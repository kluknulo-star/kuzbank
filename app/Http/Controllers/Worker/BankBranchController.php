...
class BankBranchController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('worker.bankBranches.index', compact('bankBranches'));
    }
    ...
    {
        return view('worker.bankBranches.create');
    }
    ...
    public function store(StoreBankBranchRequest $request)
    {
        ...
        return redirect()->route('worker.bankBranches.show', $bankBranch->id);
    }
    ...
    {
        return view('worker.bankBranches.show', compact('bankBranch'));
    }
    ...
    {
        return view('worker.bankBranches.edit', compact('bankBranch'));
    }
    ...
    public function update(UpdateBankBranchRequest $request, BankBranch $bankBranch)
    {
        ...
        return redirect()->route('worker.bankBranches.show', compact('bankBranch'));
    }
    ...
    public function destroy(BankBranch $bankBranch)
    {
        ...
        {
            $bankBranch->delete();
            return redirect()->route('worker.bankBranches.index');
        }
        return redirect()->route('worker.bankBranches.index')->withErrors('Не может быть удален, так как используется');
    }
}
