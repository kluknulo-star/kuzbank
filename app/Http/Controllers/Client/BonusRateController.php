...
class BonusRateController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('client.bonusRates.index', compact('bonusRates'));
    }
...
//    {
//        return view('client.bonusRates.create');
//    }
...
//
//        return redirect()->route('client.bonusRates.show', $bonusRate->id);
//    }
//
    /**
    ...
    {
        return view('client.bonusRates.show', compact('bonusRate'));
    }
//
//    /**
...
//    {
//        return view('client.bonusRates.edit', compact('bonusRate'));
//    }
//
//    /**
...
//
//        return redirect()->route('client.bonusRates.show', compact('bonusRate'));
//    }
//
//    /**
...
//        {
//            $bonusRate->delete();
//            return redirect()->route('client.bonusRates.index');
//        }
//        return redirect()->route('client.bonusRates.index')->withErrors('Не может быть удален, так как используется');
//    }
}
